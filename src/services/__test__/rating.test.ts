...
describe('Rating Service', () => {
  ...
  describe('Calculate rating for a given point', () => {
    ...
    it('should get a rating less than 1 for an ok point', () => {
      const pointData = {
        swellHeight: 0.4,
      }
  ...
  describe('Get rating based on wind and wave positions', () => {
    ...
    it('shuold get rating 3 for a beach with cross winds', () => {
    ...
    it('shuold get rating 5 for a beach with offshore winds', () => {
      const rating = defaultRating.getRatingBasedOnWindAndWavePositions(
        GeoPosition.E,
        GeoPosition.W
      );
